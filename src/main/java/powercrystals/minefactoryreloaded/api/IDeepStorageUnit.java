...
public interface IDeepStorageUnit
{
     ...
     *         May have a stackSize of 0 (indicating locked contents).
     */
     ...
     * items to amount. Will overwrite any existing stored items.
     */
    void setStoredItemType(ItemStack type, int amount);

    /**
     * @return The maximum number of items the DSU can hold. May change based on
     *         the current type stored.
     */
