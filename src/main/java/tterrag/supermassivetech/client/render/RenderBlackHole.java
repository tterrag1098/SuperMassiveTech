...
//    private void renderBillboardedQuad(double tileX, double tileY, double tileZ, float angle, float scale, float partialTickTime)
//    {
...
//          double playerPosX = player.prevPosX + (player.posX - player.prevPosX) * partialTickTime;
//          double playerPosY = player.prevPosY + (player.posY - player.prevPosY) * partialTickTime;
//          double playerPosZ = player.prevPosZ + (player.posZ - player.prevPosZ) * partialTickTime;
//          
...
//          
//          Vec3 v1 = Vec3.createVectorHelper(-rotX * scale - rotYZ * scale, -rotXZ * scale, -rotZ * scale - rotXY * scale);
//          Vec3 v2 = Vec3.createVectorHelper(-rotX * scale + rotYZ * scale, rotXZ * scale, -rotZ * scale + rotXY * scale);
//          Vec3 v3 = Vec3.createVectorHelper(rotX * scale + rotYZ * scale, rotXZ * scale, rotZ * scale + rotXY * scale);
//          Vec3 v4 = Vec3.createVectorHelper(rotX * scale - rotYZ * scale, -rotXZ * scale, rotZ * scale - rotXY * scale);
//          if (angle != 0.0F)
//          {
//            Vec3 playerVec = Vec3.createVectorHelper(playerPosX, playerPosY, playerPosZ);
...
//          tessellator.addVertexWithUV(tileX + v1.xCoord, tileY + v1.yCoord, tileZ + v1.zCoord, 0, 0);
//          tessellator.addVertexWithUV(tileX + v2.xCoord, tileY + v2.yCoord, tileZ + v2.zCoord, 1, 0);
//          tessellator.addVertexWithUV(tileX + v3.xCoord, tileY + v3.yCoord, tileZ + v3.zCoord, 1, 1);
//          tessellator.addVertexWithUV(tileX + v4.xCoord, tileY + v4.yCoord, tileZ + v4.zCoord, 0, 1);
//          
//          tessellator.draw();
//        }
//    }
