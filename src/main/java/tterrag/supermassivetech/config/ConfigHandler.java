...
public class ConfigHandler
{
    ...
    public static void init(File file)
    {
        ...
        maxGravityY = (float) config.get(section, "maxGravityY", 0.028, "The max gravity that can be applied in the Y direction, used to allow easier jumping in gravity wells so they are less annoying").getDouble(0.028);
        ...
        betterAchievements = config.get("other", "superDuperFunMode", betterAchievements, "The way the game should have been made.").getBoolean(betterAchievements);
