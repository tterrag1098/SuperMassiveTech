...
public class PacketHopperParticle implements ISMTPacket{
	...
	public void decodeInto(ByteBuf buffer) 
	{
		...
		Minecraft.getMinecraft().effectRenderer.addEffect(new EntityCustomSmokeFX(Minecraft.getMinecraft().thePlayer.worldObj, data[3] + 0.5, data[4] + 0.5, data[5] + 0.5, ((double) (data[0] - data[3])) / 10, ((double) ((data[1] + 0.5) - data[4])) / 10, ((double) (data[2] - data[5])) / 10));
	}
}
