...
public class Achievements
{
    ...
    public static void initAchievements()
    {
        ...
        Achievement craftStar = makeItemBasedAchievement("craftStar", 0, -3, new ItemStack(itemRegistry.star), new ItemStack(
                itemRegistry.star), craftHeart, true);
        Achievement getDepNetherStar = makeItemBasedAchievement("getDepletedNetherStar", 4, -2, itemRegistry.depletedNetherStar,
                itemRegistry.depletedNetherStar, craftStar);
        ...
        Achievement craftSH = makeItemBasedAchievement("craftStarHarvester", 0, 1, blockRegistry.starHarvester,
                blockRegistry.starHarvester, craftStar);
        Achievement craftContainer = makeItemBasedAchievement("craftContainer", 0, 3, itemRegistry.starContainer,
                itemRegistry.starContainer, craftSH);
        makeItemBasedAchievement("starPower", 0, 5, new ItemStack(itemRegistry.starSpecial), new ItemStack(itemRegistry.star, 1, 1),
                craftContainer, true);
        ...
        makeItemBasedAchievement("craftGravHelm", 5, 0, new ItemStack(itemRegistry.gravityHelm), new ItemStack(itemRegistry.gravityHelm, 1,
                max), getDepNetherStar);
        makeItemBasedAchievement("craftGravChest", 5, 1, new ItemStack(itemRegistry.gravityChest), new ItemStack(itemRegistry.gravityChest,
                1, max), getDepNetherStar);
        makeItemBasedAchievement("craftGravLegs", 5, 2, new ItemStack(itemRegistry.gravityLegs), new ItemStack(itemRegistry.gravityLegs, 1,
                max), getDepNetherStar);
        makeItemBasedAchievement("craftGravBoots", 5, 3, new ItemStack(itemRegistry.gravityBoots), new ItemStack(itemRegistry.gravityBoots,
                1, max), getDepNetherStar);

        Achievement rejuvenate = makeItemBasedAchievement("rejuvenateNetherStar", 4, -5, Items.nether_star, Items.nether_star,
                getDepNetherStar);
        makeItemBasedAchievement("comeFullCircle", 2, -5, new ItemStack(itemRegistry.heartOfStar, 1, 1), new ItemStack(
                itemRegistry.heartOfStar, 1, 1), rejuvenate);
    ...
    private static Achievement makeItemBasedAchievement(String basicName, int x, int y, ItemStack display, ItemStack toCraft,
            Achievement req, boolean special)
    {
